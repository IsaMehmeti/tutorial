	...
	($sidebar = $(".sidebar")),
		...
		$(".dropdown-menu a.dropdown-toggle").on("click", function(e) {
			...
			return (
				...
				t.parent().hasClass("navbar-nav") ||
					a
						.next()
						.css({ top: a[0].offsetTop, left: t.outerWidth() - 4 }),
				!1
			);
		}),
		...
		1 == breakCards &&
			$('[data-header-animation="true"]').each(function() {
				...
				a.find(".fix-broken-card").click(function() {
					...
					e.removeClass("hinge").addClass("fadeInDown"),
						a.attr("data-count", 0),
						setTimeout(function() {
					...
					a.mouseenter(function() {
						var e = $(this);
						(hover_count =
							parseInt(e.attr("data-count"), 10) + 1 || 0),
							e.attr("data-count", hover_count),
							20 <= hover_count &&
								$(this)
									.children(
			...
			($sidebar_wrapper = $(".sidebar-wrapper")),
				mobile_menu_initialized
					...
					: (($navbar = $("nav")
					  ...
					  $(
							".sidebar-wrapper .dropdown .dropdown-menu > li > a"
					  ).click(function(e) {
							e.stopPropagation();
					  }),
					  window.dispatchEvent(new Event("resize")),
